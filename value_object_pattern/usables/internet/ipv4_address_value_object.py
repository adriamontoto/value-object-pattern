...
class Ipv4AddressValueObject(NotEmptyStringValueObject, TrimmedStringValueObject):
    ...
    def is_reserved(cls, *, value: str) -> bool:
        ...
        """
        try:
            value = cls._ipv4_address_normalize(value=value)
            return cls._ipv4_address_validate(value=value).is_reserved
    ...
    def is_private(cls, *, value: str) -> bool:
        ...
        try:
            value = cls._ipv4_address_normalize(value=value)
            return cls._ipv4_address_validate(value=value).is_private
    ...
    def is_global(cls, *, value: str) -> bool:
        ...
        try:
            value = cls._ipv4_address_normalize(value=value)
            return cls._ipv4_address_validate(value=value).is_global
    ...
    def is_multicast(cls, *, value: str) -> bool:
        ...
        try:
            value = cls._ipv4_address_normalize(value=value)
            return cls._ipv4_address_validate(value=value).is_multicast
    ...
    def is_unspecified(cls, *, value: str) -> bool:
        ...
        try:
            value = cls._ipv4_address_normalize(value=value)
            return cls._ipv4_address_validate(value=value).is_unspecified
    ...
    def is_loopback(cls, *, value: str) -> bool:
        ...
        try:
            value = cls._ipv4_address_normalize(value=value)
            return cls._ipv4_address_validate(value=value).is_loopback
    ...
    def is_link_local(cls, *, value: str) -> bool:
        ...
        try:
            value = cls._ipv4_address_normalize(value=value)
            return cls._ipv4_address_validate(value=value).is_link_local
