...
class TemporalCompanyRegisteredPlateValueObject(NotEmptyStringValueObject, TrimmedStringValueObject):
    ...
    Example:
    ```python
    from value_object_pattern.usables.identifiers.world.continents.countries.spain.plates import TemporalCompanyRegisteredPlateValueObject
    ...
    def _raise_value_is_not_temporal_company_registered_plate(self, value: str) -> NoReturn:
        """
        Raises a ValueError if the value object `value` is not a valid Spanish temporal company registered plate.
