...
class DiplomaticCorpsPlateValueObject(NotEmptyStringValueObject, TrimmedStringValueObject):
    ...
    Example:
    ```python
    from value_object_pattern.usables.identifiers.world.continents.countries.spain.plates import DiplomaticCorpsPlateValueObject
    ...
    def _raise_value_is_not_diplomatic_corps_plate(self, value: str) -> NoReturn:
        """
        Raises a ValueError if the value object `value` is not a valid Spanish diplomatic corps plate.
