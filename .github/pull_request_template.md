...
> - Closes: [#\<issue-number>](https://github.com/adriamontoto/value-object-pattern/issues/<issue-number>), ...
> - Related to: [#\<issue-number>](https://github.com/adriamontoto/value-object-pattern/issues/<issue-number>), ...
-->

## ✅ Pre-merge Checklist

- [ ] I have read and followed the [`🤝 Contributor Guidelines`](https://github.com/adriamontoto/value-object-pattern/blob/master/.github/CONTRIBUTING.md).
- [ ] I have read and followed the [`🧭 Code of Conduct`](https://github.com/adriamontoto/value-object-pattern/blob/master/.github/CODE_OF_CONDUCT.md).
