...
from value_object_pattern.usables.primitives import UppercaseStringValueObject
...
def test_uppercase_string_value_object_happy_path() -> None:
    ...
    """
    string_value = UppercaseStringValueObject(value=StringMother.create().upper())
...
def test_uppercase_string_value_object_invalid_value() -> None:
    ...
    with assert_raises(
        ...
        UppercaseStringValueObject(value=StringMother.create().lower())
